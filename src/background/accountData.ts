...
export const updateAccountsData = async (
  accounts: Accounts,
...
export const storeHistoricalData = (
  ...
  chrome.storage.local.get(
    ...
    (result) => {
      ...
      if (
        accountsHistory.length &&
        accountsHistory.length >= historicalDataPeriod
      ) {
...
export const updateAndStoreAccounts = async () => {
